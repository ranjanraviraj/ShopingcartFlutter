    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        await Provider.of<Auth>(context, listen: false).signIn(
          _authData[Constant.EMAIL],
          _authData[Constant.PASSWORD],
        );
      } else {
      ...
      const errorMessage = 'Could not autheticate you. Please try again!';
      _showDialog(errorMessage);
    }
            ...
            child: Column(
              children: <Widget>[
                TextFormField(
                  ...
                  onSaved: (value) {
                    _authData[Constant.EMAIL] = value;
                  },
                ),
                TextFormField(
                  ...
                  onSaved: (value) {
                    _authData[Constant.PASSWORD] = value;
                  },
                ),
                AnimatedContainer(
                  duration: Duration(milliseconds: 300),
